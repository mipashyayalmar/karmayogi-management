...
class AddressInfo(models.Model):
    userprofile = models.ForeignKey(UserProfile,on_delete=models.Case,default='prasad')
...
class PersonalInfo(models.Model):
    ...
    employee_type = models.CharField(choices=UserProfile.employee_select, max_length=15)
    is_delete = models.BooleanField(default=False)
    administration = models.ForeignKey(Designation, on_delete=models.CASCADE,default='prasad')
    photo = models.ImageField(upload_to='uploads/', default='default_images/default.png')
    ...
    caste = models.CharField(choices=caste_choice, max_length=10, null=True, blank=True)
    ...
    e_tin = models.TextField(unique=True)
